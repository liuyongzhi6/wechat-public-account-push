export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx47f742bbe0220216",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "b2b2fd85cf77fae554a53bd22d12f3b0",
  /**
  ...
  USERS: [
    {
      ...
      id: "oQpxU6C63HTuYIhxsVrwropBH4XI",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "xQBcC2i2Ssz3ldgL7PhZDbfySz0an8Y1NsIDhNUiJgY",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "肇庆",
